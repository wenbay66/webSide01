...
const Footer = () => {
  ...
  return (
    <section className='flex justift-center items-center py-6 sm:py-16 flex-col'>
      <div className='flex justift-center items-start flex-col md:flex-row mb-8 w-full'>
